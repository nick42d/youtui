use crate::app::component::actionhandler::{
    DelegateScrollable, DelegateTextHandler, Scrollable, TextHandler,
};
...
impl DelegateScrollable for PlaylistSearchBrowser {
...
impl DelegateTextHandler for PlaylistSearchBrowser {}
