...
### Fixed
- Move to new rusty_ytdl version (reduces number of downloading 403 errors), and add new scheduled test for downloading ([#134](https://github.com/nick42d/youtui/pull/134))- Oauth refresh can no longer get cancelled ([#124](https://github.com/nick42d/youtui/pull/124))
### Other
