...
## [0.0.37](https://github.com/nick42d/youtui/compare/youtui/v0.0.36...youtui/v0.0.37) - 2026-05-05

### Fixed
- Better declare image size ([#365](https://github.com/nick42d/youtui/pull/365))

### Other
- Update deps ([#363](https://github.com/nick42d/youtui/pull/363))
- release ([#349](https://github.com/nick42d/youtui/pull/349))
...
### Added
- Scroll selected items text in list when too long to fit in column. ([#312](https://github.com/nick42d/youtui/pull/312))
- Put links to README auth guides into errors ([#318](https://github.com/nick42d/youtui/pull/318))
...
### Fixed
- prevent downloads continually retying ([#279](https://github.com/nick42d/youtui/pull/279))
...
### Added
- CLI: Add GetUser queries ([#265](https://github.com/nick42d/youtui/pull/265))
- CLI: Add subscribe/unsubscribe artists queries ([#264](https://github.com/nick42d/youtui/pull/264))
- CLI: Added additional playlist queries ([#260](https://github.com/nick42d/youtui/pull/260))
- CLI: Add GetLibraryPodcasts and GetLibraryChannels queries ([#259](https://github.com/nick42d/youtui/pull/259))
- CLI: Add continuations for GetLibraryUpload queries ([#258](https://github.com/nick42d/youtui/pull/258))
- CLI: Add continuations for search queries ([#257](https://github.com/nick42d/youtui/pull/257))
